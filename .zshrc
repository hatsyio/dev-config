...
# History — set after oh-my-zsh.sh so these win over its defaults (it only raises,
# never lowers). Bumped well above the existing history file so nothing is truncated.
HISTSIZE=200000
SAVEHIST=200000
setopt hist_ignore_all_dups   # drop older dupes entirely, keep history dense
